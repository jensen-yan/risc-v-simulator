...
struct OOOPipelineConfig {
    ...
    static constexpr size_t LOAD_QUEUE_ENTRIES = ROB_ENTRIES;
    static constexpr size_t STORE_QUEUE_ENTRIES = ROB_ENTRIES;
    static constexpr size_t STORE_FORWARDING_BUFFER_ENTRIES = ROB_ENTRIES;
};
